...
let repairPicturesArray = document.querySelectorAll(
  "div.carousel-flex-image img"
);
let fleckenPicturesArray = document.querySelectorAll(
  "div.carousel-flex-image-flecken img"
);
let justCarouselPartContainer = document.querySelector(
  "div.carousel-container"
);
let justCarouselPartContainerFlecken = document.querySelector(
  "div.carousel-container-flecken"
);
...
let justCarouselFleckenImages = document.querySelectorAll(
  "div.image-container-flecken img"
);
let carouselRemover = document.querySelector("span.remove-carousel");
let carouselRemoverFlecken = document.querySelector(
  "span.remove-carousel-flecken"
);
...
let imageContainerFelecken = document.querySelectorAll(
  "div.image-container-flecken"
);
let counter = 1;

let mainArray = [
  {
    identitiy: "image flecken",
    src: "images/teppisch-images/staub/staub1.jpeg",
  },
  {
    identitiy: "image flecken",
    src: "images/teppisch-images/staub/staub2.jpeg",
  },
  {
    identitiy: "image flecken",
    src: "images/teppisch-images/staub/staub3.jpeg",
  },
  {
    identitiy: "image flecken",
    src: "images/teppisch-images/staub/staub4.jpeg",
  },

  {
    identitiy: "image reparatur",
    src: "images/teppisch-images/sorg/sorg1.jpeg",
  },
  {
    identitiy: "image reparatur",
    src: "images/teppisch-images/sorg/sorg2.jpeg",
  },
  {
    identitiy: "image reparatur",
    src: "images/teppisch-images/sorg/sorg3.jpeg",
  },
  {
    identitiy: "image reparatur",
    src: "images/teppisch-images/sorg/sorg4.jpeg",
  },

  {
    identitiy: "image sauna",
    src: "images/teppisch-images/teppich-sauna/sauna1.jpeg",
  },
  {
    identitiy: "image sauna",
    src: "images/teppisch-images/teppich-sauna/sauna2.jpeg",
  },
  {
    identitiy: "image sauna",
    src: "images/teppisch-images/teppich-sauna/sauna3.jpeg",
  },
  {
    identitiy: "image sauna",
    src: "images/teppisch-images/teppich-sauna/sauna4.jpeg",
  },

  {
    identitiy: "image kontrolle",
    src: "images/teppisch-images/ende-kontrolle/ende-kontrolle1.jpeg",
  },
  {
    identitiy: "image kontrolle",
    src: "images/teppisch-images/ende-kontrolle/ende-kontrolle2.jpeg",
  },
  {
    identitiy: "image kontrolle",
    src: "images/teppisch-images/ende-kontrolle/ende-kontrolle3.jpeg",
  },
  {
    identitiy: "image kontrolle",
    src: "images/teppisch-images/ende-kontrolle/ende-kontrolle4.jpeg",
  },

  {
    identitiy: "image wash",
    src: "images/teppisch-images/scleudern/scleudern1.jpeg",
  },
  {
    identitiy: "image wash",
    src: "images/teppisch-images/scleudern/schleudern2.jpeg",
  },
  {
    identitiy: "image wash",
    src: "images/teppisch-images/scleudern/schleudern3.jpeg",
  },
  {
    identitiy: "image wash",
    src: "images/teppisch-images/scleudern/schleudern4.jpeg",
  },

  {
    identitiy: "image lieferung",
    src: "images/teppisch-images/lieferung/lieferung1.jpg",
  },
  {
    identitiy: "image lieferung",
    src: "images/teppisch-images/lieferung/lieferung2.jpg",
  },
  {
    identitiy: "image lieferung",
    src: "images/teppisch-images/lieferung/lieferung3.jpg",
  },
  {
    identitiy: "image lieferung",
    src: "images/teppisch-images/lieferung/lieferung4.jpg",
  },
];
...
for (let i = 0; i < sixSteps.length; i++) {
  sixSteps[i].addEventListener("click", function (ev) {
    ...
    let filterImages = mainArray.filter(
      (elem) => elem.identitiy === targetIdentifier
    );
